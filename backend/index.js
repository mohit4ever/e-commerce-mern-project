...
// schema for creating mongoose product
...
// creating endponint for registering user
...
// creating api endoint for user login
...
// creating api fpr new collection data

app.get("/newcollection", async (req, res) => {
    let products = await Product.find({})
    let newcollection = products.slice(1).slice(-8);
    console.log("new collection is here")
...
app.get("/popularinwomen", async (req, res) => {
    ...
    console.log("popular in womem fetched")
    res.send(popularinwomen)
})

// middlewere for fetch user
...
// create endoint for add to cart
...
// creating endpoint for get all card data display
